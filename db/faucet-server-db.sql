...
ALTER TABLE faucet.auth_channel OWNER TO postgres;
...
ALTER TABLE faucet.auth_provider OWNER TO postgres;
...
ALTER TABLE faucet.distribution OWNER TO postgres;

--
-- Name: distribution_distribution_id_seq; Type: SEQUENCE; Schema: faucet; Owner: postgres
--

CREATE SEQUENCE faucet.distribution_distribution_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE faucet.distribution_distribution_id_seq OWNER TO postgres;
...
ALTER TABLE ONLY faucet.distribution ALTER COLUMN distribution_id SET DEFAULT nextval('faucet.distribution_distribution_id_seq'::regclass);
...
ALTER TABLE ONLY faucet.auth_channel
    ADD CONSTRAINT auth_channel_pk PRIMARY KEY (auth_name);
...
ALTER TABLE ONLY faucet.auth_provider
    ADD CONSTRAINT auth_provider_pk PRIMARY KEY (auth_provider);
...
ALTER TABLE ONLY faucet.distribution
...
ALTER TABLE ONLY faucet.auth_channel
    ADD CONSTRAINT auth_channel_fk FOREIGN KEY (auth_provider) REFERENCES faucet.auth_provider(auth_provider);
